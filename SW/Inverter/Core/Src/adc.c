...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* adcHandle)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PA3     ------> ADC1_IN3
    */
    HAL_GPIO_DeInit(GPIOA, ia_L_Pin|ib_L_Pin|ic_L_Pin|VDC_L_Pin);
  ...
  /* USER CODE END ADC2_MspDeInit 0 */
    ...
    PB1     ------> ADC2_IN9
    */
    HAL_GPIO_DeInit(GPIOA, ia_R_Pin|ib_R_Pin);

    HAL_GPIO_DeInit(GPIOB, ic_R_Pin|VDC_R_Pin);
  ...
  /* USER CODE END ADC3_MspDeInit 0 */
    ...
    PC3     ------> ADC3_IN13
    */
    HAL_GPIO_DeInit(GPIOC, Tinv_L_Pin|Tinv_R_Pin|Tmot_L_Pin|Tmot_R_Pin);
